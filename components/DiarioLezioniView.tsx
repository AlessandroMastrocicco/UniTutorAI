...
export const DiarioLezioniView: React.FC<DiarioLezioniViewProps> = ({ selectedSubject, diaries }) => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto">
            <header className="mb-6 text-center">
                <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Diario Lezioni</h1>
