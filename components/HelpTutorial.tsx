            ...
            return {
                ...
                content: (
                    <>
                        ...
                        <TutorialHeading>Tutor AI Contestuale</TutorialHeading>
                        <TutorialText>Mentre visualizzi una dispensa, apri la chat <strong>"Tutor AI"</strong> (icona con la scintilla) per fare domande specifiche. L'AI risponderà basandosi esclusivamente sul contenuto della dispensa che stai leggendo, fornendoti spiegazioni mirate.</TutorialText>
                    </>
                )
            };
         case 'appunti':
            return {
                ...
                content: (
                    <>
                        ...
                        <TutorialText>L'editor ti permette di non solo formattare il testo (titoli, grassetto, corsivo), ma anche di passare alla modalità <strong>"Disegna"</strong>. Questa funzione trasforma l'area di testo in una tela dove puoi aggiungere schemi, grafici e formule a mano libera. Quando torni alla modalità testo, il tuo disegno viene inserito direttamente nell'appunto come un'immagine.</TutorialText>
                        <TutorialHeading>Recensione AI</TutorialHeading>
                        <TutorialText>Dopo aver scritto i tuoi appunti, clicca su <strong>"Recensione AI"</strong>. L'AI analizzerà il testo per darti un feedback su chiarezza, completezza e correttezza. Per una revisione ancora più accurata, puoi scegliere di fornire una delle tue dispense come contesto: l'AI confronterà i tuoi appunti con il materiale originale per darti suggerimenti più pertinenti.</TutorialText>
                    </>
                )
            };
        case 'esercitazioni':
            return {
                ...
                content: (
                    <>
                        ...
                        <TutorialText>La sezione è organizzata per "Macro-argomenti" (i temi principali) e "Pointers" (i micro-argomenti specifici). Questi vengono estratti automaticamente dall'AI quando carichi una dispensa.</TutorialText>
                        <TutorialHeading>Genera e Risolvi</TutorialHeading>
                        <TutorialList>
                            <li>Clicca su un pointer per entrare nella sua schermata dedicata.</li>
                            <li>Premi <strong>"Crea Nuovo Esercizio"</strong>. L'AI genererà un esercizio su misura basandosi sul contenuto del pointer e sulle tue performance passate (se presenti).</li>
                            <li>Puoi risolvere l'esercizio in tre modi: scrivendo testo nell'editor, disegnando la soluzione su una lavagna virtuale o caricando una foto/PDF della tua risoluzione.</li>
                        </TutorialList>
                        <TutorialHeading>Aiuto dal Tutor</TutorialHeading>
                        <TutorialText>Se sei bloccato, clicca su <strong>"Chiedi al Tutor AI"</strong>. Puoi fare una domanda specifica e l'AI ti fornirà un suggerimento mirato per guidarti verso la soluzione, senza però svelartela completamente.</TutorialText>
                    </>
                )
            };
        case 'chat':
            return {
                ...
                content: (
                     <>
                        ...
                        <TutorialText>In qualsiasi momento, puoi mettere in pausa la lezione e cliccare sull'icona con il punto di domanda. Si aprirà una chat dove potrai chiedere chiarimenti sull'argomento che il tutor sta spiegando. L'AI risponderà contestualmente.</TutorialText>
            ...
            return {
                ...
                content: (
                    <>
                        ...
                        <TutorialHeading>Creazione Simulazione</TutorialHeading>
                        <TutorialList>
                            <li><strong>Seleziona le Dispense:</strong> Scegli da quali dei tuoi materiali di studio l'AI deve attingere per creare le domande.</li>
                            <li><strong>Definisci la Struttura:</strong> Imposta il numero e il tipo di domande (risposta multipla/aperta, teoria/esercizi) e la durata del timer per replicare le condizioni del tuo esame reale.</li>
                            <li><strong>Generazione Adattiva:</strong> L'AI non crea domande a caso. Analizza le tue performance passate nella sezione "Esercitazioni" e dà priorità agli argomenti su cui hai maggiori difficoltà, aiutandoti a migliorare proprio dove serve di più.</li>
                        </TutorialList>
                         <TutorialHeading>Impara dalle Tracce Passate</TutorialHeading>
                        <TutorialText>Usa il pulsante <strong>"Tracce d'esame passate"</strong> per caricare i PDF di vecchi esami. L'AI li analizzerà per estrarne automaticamente la struttura (numero/tipo di domande, durata). Potrai poi applicare con un click la struttura di un vecchio esame a una nuova simulazione, per un allenamento ancora più fedele.</TutorialText>
                        <TutorialHeading>Svolgimento e Risultati</TutorialHeading>
                        <TutorialText>Durante la prova, un timer ti aiuterà a gestire il tempo. Al termine, riceverai subito il punteggio per le domande a risposta multipla. Per le risposte aperte, l'AI impiegherà qualche istante per valutarle e fornirti un feedback dettagliato su correttezza, completezza e pertinenza.</TutorialText>
                    </>
                )
            };
        case 'databaseApp':
             return {
                ...
                content: (
                     <>
                        <TutorialText>Questa è la tua centrale analitica. Qui puoi visualizzare in modo strutturato tutti i "pointers" (micro-argomenti) che l'AI ha estratto dalle tue dispense per la materia selezionata.</TutorialText>
                        ...
                        <TutorialText>Cliccando su un pointer, puoi visualizzare il contenuto testuale originale della dispensa da cui è stato estratto, per un ripasso veloce e contestualizzato.</TutorialText>
                    </>
                )
            };
        case 'calendario':
            ...
            return {
                ...
                content: (
                    <>
                        ...
                        <TutorialText>Usa l'interruttore per passare dal tema scuro (predefinito) a un tema chiaro. La tua scelta verrà salvata e mantenuta per le tue prossime sessioni di utilizzo dell'app.</TutorialText>
                    </>
                )
            };
        default:
