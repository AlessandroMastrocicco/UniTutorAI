...
const TutorialText: React.FC<{ html?: string; children?: React.ReactNode }> = ({ html, children }) => {
    const commonClasses = "text-gray-300 mb-4 leading-relaxed";
    if (html) {
        return <p className={commonClasses} dangerouslySetInnerHTML={{ __html: html }} />;
    }
    ...
    switch (activeView) {
        case 'dashboard':
            return {
                ...
                content: (
                    <>
                        <TutorialText html={t('tutorial.dashboard.intro')} />
                        <TutorialHeading>{t('tutorial.dashboard.agendaTitle')}</TutorialHeading>
                        <TutorialText html={t('tutorial.dashboard.agendaText')} />
                        <TutorialHeading>{t('tutorial.dashboard.tasksTitle')}</TutorialHeading>
                        <TutorialText html={t('tutorial.dashboard.tasksText')} />
                        <TutorialHeading>{t('tutorial.dashboard.examsTitle')}</TutorialHeading>
                        <TutorialText html={t('tutorial.dashboard.examsText')} />
                        <TutorialHeading>{t('tutorial.dashboard.subjectsTitle')}</TutorialHeading>
                        <TutorialText html={t('tutorial.dashboard.subjectsText')} />
                    </>
                )
            };
        case 'details':
