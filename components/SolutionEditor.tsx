...
export const SolutionEditor: React.FC<{
    ...
    useEffect(() => {
        ...
        const syncCanvasSize = () => {
            const newWidth = Math.max(editorEl.scrollWidth, editorWidth);
            const newHeight = Math.max(editorEl.scrollHeight, editorMinHeight);
        ...
        const mutationObserver = new MutationObserver(syncCanvasSize);
