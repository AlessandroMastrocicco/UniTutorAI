...
const IconClipboard = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" /><path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3z" clipRule="evenodd" /></svg>;
                             ...
                             <ul className="divide-y divide-gray-700">
                                 {details.examDates.map((exam) => (
                                     <li key={exam.id} className="py-3 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                                         ...
                                         <div className="flex items-center text-sm text-gray-300"><IconClipboard /> {exam.type}</div>
                                     </li>
                                 ))}
                             </ul>
                         ) : (
