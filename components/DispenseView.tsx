        ...
        const loadPdfAndGenerateThumbnails = async () => {
            ...
            try {
                ...
                handleSelectAll(pdf.numPages);
                 ...
                 // FIX: The error object `err` is of type `unknown`. We must check if it's an Error instance before accessing `message`, or convert it to a string for other cases.
