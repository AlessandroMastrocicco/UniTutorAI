...
const AiTutorModal: React.FC<{
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            // FIX: The caught error object 'e' is of type 'unknown' and cannot be directly used as a string.
            // It is now safely handled by checking if it's an Error instance or converting it to a string.
