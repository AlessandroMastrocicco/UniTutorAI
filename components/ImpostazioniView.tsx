...
export const ImpostazioniView: React.FC<ImpostazioniViewProps> = ({ theme, onThemeChange, language, onLanguageChange, pointerVisibility, onPointerVisibilityChange, isGlobalTutorEnabled, userName, isTutorContextualAnalysisEnabled, onUpdateTutorSettings, onResetTutorChat, t }) => {
