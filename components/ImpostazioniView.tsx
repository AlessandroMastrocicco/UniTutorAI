...
export const ImpostazioniView: React.FC<ImpostazioniViewProps> = ({ theme, onThemeChange, language, onLanguageChange, pointerVisibility, onPointerVisibilityChange, t }) => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-2xl p-6">
                ...
                <h2 className="text-xl font-bold text-white mb-6 mt-8 pt-6 border-t border-gray-700">{t('settings.appLogic')}</h2>
                <div className="space-y-4">
                    <div className="flex justify-between items-center p-4 bg-gray-900/50 rounded-lg">
                        <div>
