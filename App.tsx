...
const GlobalTutorView: React.FC<{
    ...
    onCancelAction: () => void;
}> = ({ isOpen, onClose, state, userName, activeSubject, allSubjects, chatHistory, onSendMessage, onCompleteTask, isProcessing, t, pendingAction, onCancelAction }) => {
...
${contextText || "Nessun testo di riferimento fornito. Basa la tua analisi sulla correttezza generale dell'argomento e imposta 'fidelityPercentage' a null."}`;
    ...
    }, [ai, globalTutorChatHistory, selectedSubject, allEsercizioTopics, subjects, userName, language, generateContentWithModelSwitching]);
