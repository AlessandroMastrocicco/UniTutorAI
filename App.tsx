...
const GlobalTutorView: React.FC<{
    ...
    onCancelAction: () => void;
}> = ({ isOpen, onClose, state, userName, activeSubject, allSubjects, chatHistory, onSendMessage, onCompleteTask, isProcessing, t, sidebarOpen, pendingAction, onCancelAction }) => {
