...
import type { SubjectDetails, SavedDispensa, Appunto, LessonDiary, SavedSimulation, MacroTopic, EsercizioTopic, EsercizioInstance, ChatMessage, Thumbnail, LearnedExam } from './types';
